...
<body>
    <div class="container">
        ...
        <div class="footer">
            ...
            <a href="https://www.angry-shark-studio.com/blog/python-unity-build-automation-tutorial">Read the Tutorial</a><br>
...
"""
    ...
    def _generate_build_rows(self, build_results: List[Dict[str, Any]]) -> str:
        ...
        for result in build_results:
            ...
            # Additional data from build summary
            scene_count = result.get('scene_count', 'N/A')
            warnings_count = result.get('warnings_count', 'N/A')
            
            # Format warnings with color
            if warnings_count != 'N/A' and warnings_count > 0:
                warnings_text = f'<span style="color: #ff9800;">{warnings_count}</span>'
            else:
                warnings_text = str(warnings_count)
